...
const CanadaFlagIcon = (props: React.SVGProps<SVGSVGElement>) => {
  ...
  return (
    <svg
      ...
      height="1em"
      viewBox="0 0 301 151"
      className={cn(className)} // Apply only the passed className
      aria-label={props["aria-label"] || "Canadian Flag"}
      role={props.role || "img"}
      {...rest}
    >
