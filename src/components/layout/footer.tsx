...
export default function Footer() {
  ...
  const fullCopyrightText = getTranslatedString(
    translations.footerCopyrightText,
    language
  );
  const emailLabelText = getTranslatedString(
    translations.contactEmailLabel,
    language
  );
  const socialNavLabelText = getTranslatedString(
    translations.socialMediaNavLabel,
    language
  );
  const bloggerLabelText = getTranslatedString(
    translations.socialBloggerLabel,
    language
  );
  const youtubeLabelText = getTranslatedString(
    translations.socialYoutubeLabel,
    language
  );
  const blueskyLabelText = getTranslatedString(
    translations.socialBlueskyLabel,
    language
  );
  const threadsLabelText = getTranslatedString(
    translations.socialThreadsLabel,
    language
  );
  const footerDisclaimerText = getTranslatedString(
