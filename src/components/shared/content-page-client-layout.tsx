...
export default function ContentPageClientLayout({
  ...
  const title = 
    typeof rawTitle === 'object' && rawTitle !== null && typeof rawTitle[language] === 'string'
      ? rawTitle[language]
      : typeof rawTitle === 'string' 
        ? rawTitle 
        : (language === 'en' ? defaultTitleEn : defaultTitleZh); // Fallback to pageData is acceptable here
  ...
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-10rem)]">
      ...
      <div className="bg-background/50 p-6 sm:p-8 md:p-12 rounded-xl max-w-4xl mx-auto border">
