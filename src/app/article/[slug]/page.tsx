...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!article) {
    ...
    const notFoundTitleText =
      typeof rawArticleNotFoundMetaTitleEntry === "object" && rawArticleNotFoundMetaTitleEntry !== null && typeof rawArticleNotFoundMetaTitleEntry["en"] === "string"
            ...
            <div className="text-sm text-muted-foreground">
              ...
              {article.date_updated_shown && (
                <div className="flex items-center">
                  ...
                  <span>
                    {updatedOnText}{" "}
                    {format(new Date(article.date_updated), "MMMM d, yyyy")}
                  </span>
                </div>
              )}
            </div>
