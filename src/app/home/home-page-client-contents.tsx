      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 pb-10">
            <Button
              asChild
              className="h-auto bg-primary hover:bg-primary/90 text-primary-foreground rounded-full px-5 py-2.5 text-base sm:px-6 sm:py-3 sm:text-lg border transition-transform hover:scale-105 whitespace-nowrap shadow-md hover:shadow-lg"
            >
