...
export default function HomePageClientContents({
  ...
  const leadSectionDescriptionText = getTranslatedString(translations.leadSectionDescription, language);
  ...
  useEffect(() => {
    const processMarkdown = async () => {
        ...
        const [feesFile, locationFile, focusFile, questionsFile, approach1File, approach2File, approach3File, leadDescFile] = await Promise.all([
            feesPromise, 
            locationPromise, 
            focusPromise, 
            questionsPromise,
    ...
    if (serviceFeesDescMarkdown && serviceLocationDescMarkdown && serviceFocusAreasDescMarkdown && serviceQuestionsDescMarkdown && leadSectionDescriptionText) {
      processMarkdown();
    }
  }, [
    language, 
  ...
  const leadSectionTitleId = "lead-section-title";
  ...
  const leadSectionTitleText = getTranslatedString(translations.leadSectionTitle, language);
  const leadSectionSubtitleText = getTranslatedString(translations.leadSectionSubtitle, language);
  ...
  return (
    <div className="flex flex-col font-headline">
      ...
      <section
        ...
        aria-labelledby={leadSectionTitleId}
      >
            ...
            <CardContent className="p-6 md:p-8">
              ...
              <div className="text-left mt-6 lead-section-description text-muted-foreground">
                <div className="markdown-content">
                    {parse(leadSectionHtml, parserOptions)}
                </div>
              </div>
            </CardContent>
          </Card>
